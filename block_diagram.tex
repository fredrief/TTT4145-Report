...
% -------- TX --------- %
\filldraw[fill=black!10!white, draw=black!10!white, opacity=0.5] (-1,1.5) rectangle (13,-1);
\draw (-1,1.5) node[anchor=north west]{TX - Software};
% Draw boxes
\draw 
...
% -------- RX --------- %
\filldraw[fill=black!10!white, draw=black!10!white, opacity=0.5] (-1,-1.5) rectangle (13,-6.5);
\draw (-1,-1.5) node[anchor=north west]{RX - Software};
% Draw boxes
\draw 
(0,-3) node[box](sound_cons){Sound \\ consumer} 
...
\draw [->, thick] (unpack_rx.west) -- (sound_cons.east);
