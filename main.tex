...
% ------------------------ MEASUREMENTS -----------------------------%
\newcommand{\measBW}{232} %kHz, -60dBc
...
\newcommand{\measBERQPSKGood}{$1.35\cdot10^{-5}$} 
\newcommand{\measBERQAMGood}{$6.0\cdot10^{-2}$} 
\newcommand{\measBERQPSKBad}{$1.4\cdot10^{-4}$} 
\newcommand{\measBERQAMBad}{$1.32\cdot10^{-1}$} 
